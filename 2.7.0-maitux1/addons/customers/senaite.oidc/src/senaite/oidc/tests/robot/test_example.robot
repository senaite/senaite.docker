...
#
#  $ bin/test -s senaite.oidc -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src senaite.oidc.testing.SENAITE_OIDC_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/senaite/oidc/tests/robot/test_example.robot
#
