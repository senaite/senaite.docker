...
class StockBatchLabelTemplates(object):
    default_template = "maitux.labeldesign:InventoryNormal_40x20mm.pt"
    ...
    def __call__(self, request):
        return [
            {
                "id": "maitux.labeldesign:InventoryNormal_40x20mm.pt",
                "title": "库存标签 (Inventory Normal)",
            },
            {
                "id": "maitux.labeldesign:InventoryReference_40x20mm.pt",
                "title": "库存标签·对照品 (Inventory Reference)",
            },
            {
                "id": "maitux.labeldesign:InventoryStability_40x20mm.pt",
